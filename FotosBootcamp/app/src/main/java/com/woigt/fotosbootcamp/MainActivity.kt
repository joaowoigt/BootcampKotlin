package com.woigt.fotosbootcamp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pick_button.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ) {  // Se o Sdk é maior que Marshmallow
    ...
    override fun onRequestPermissionsResult(
        ...
        when (requestCode) {
            ...
            PERMISSION_CODE_CAMERA_CAPTURE -> {
                if (grantResults.size > 1 // Como são duas permissões precisam ser garantidas
